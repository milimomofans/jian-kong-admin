<template>
    <div ref="sliderContainer" class="slider-verification">
        <div class="slider-left-bg" :style="sliderLeftWidthStyle"></div>
        <div :class="verifySuccess ? 'prompt-text-success' : 'prompt-text'">
            {{ verifySuccess ? '验证通过' : '请按住滑块，拖动到最右边' }}
        </div>
        <div
            ref="slider"
